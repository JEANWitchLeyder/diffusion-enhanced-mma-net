...
OPTION.initial_STM = './models/initial_STM.pth.tar'

OPTION.resume_ATT = './models/VIL100/60_lr0.001deay1e-6_sgd/ATT/recurrent35.pth.tar'

OPTION.resume_STM = './models/VIL100/60_lr0.001deay1e-6_sgd/STM/recurrent35.pth.tar'
